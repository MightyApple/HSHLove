...
export default function ChatUserList({ chatRooms, matchedUsers, onlineUsers }) {
  ...
  var selectedChatRoom = chatRooms.find((chatRoom) =>
    chatRoom.users.some((user) => user._id === selectedUser?.userId)
  );
        ...
        <div className={"wideChat"}>
          <div>
            ...
            <div className={"primaryContainer"}>
              <Trenner></Trenner>
              <p>
                Du möchtest Dich mit mehr Menschen in Kontakt setzen? <br />
                <br />
                Dann schau Dir weitere Profile an oder bearbeite dein Profil.
              </p>
            </div>
          </div>
